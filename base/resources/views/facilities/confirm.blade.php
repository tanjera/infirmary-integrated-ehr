        ...
        <div class="container p-2">
            <div class="card">
                ...
                <div class="card-body table table-responsive">
                    ...
                    <p class="text-sm p-2">
                        Are you sure you want to delete this facility (unit/ward)?
                    </p>
                    <table class="table">
                        <thead>
                        <tr>
                    ...
                    <div class="relative grid grid-cols-2 flex w-auto gap-6 p-2 items-center">
                        <div class="flex justify-center">
                            <a href="/facilities" class="btn btn-outline-primary px-3 py-1 text-sm">No</a>
                        </div>
                        <div class="flex justify-center">
                            <a href="/facilities/delete/process/{{ $facility->id }}" class="btn btn-outline-danger px-3 py-1 text-sm">Yes</a>
                        </div>
                    </div>
                    </div>
                </div>
