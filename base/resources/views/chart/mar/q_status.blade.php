<x-chart.chart :patient="$patient">
    ...
    @section("chart_content")
        <form method="POST" action="/chart/mar/q_status/{{$dose->id}}">
            @csrf
            ...
            <div class="relative grid grid-cols-2 flex w-auto gap-6 p-2 items-center">
                <div class="flex justify-center">
                    <a href="/chart/mar/q_dose/{{$dose->id}}" class="btn btn-outline-danger px-3 py-1 text-sm">Cancel</a>
                </div>
                <div class="flex justify-center">
